...
export default function DesigningForAConference() {
  return (
    <CaseStudyLayout
      title="Designing for a Conference"
      subtitle="I led the creative direction and web design for Litmus' annual email conference across 2016 and 2017. This included rebranding, website development, and visual identity across cities."
      tags={['Sr. Product Designer', 'Web Design & Development', 'Creative Direction', '2016 - 17']}
      variant="v2"
    >
      ...
      <h3>2016: The Email Design Conference</h3>
      ...
      <div className="image-full">
        <img src="/images/tedc/2016-save-the-date.png" alt="The Email Design Conference 2016 Save the Date page" />
      </div>
      ...
      <div className="image-full">
        <img src="/images/tedc/2016-san-francisco.png" alt="The Email Design Conference - San Francisco with Golden Gate Bridge" />
      </div>

      <div className="image-full">
        <img src="/images/tedc/2016-london.png" alt="The Email Design Conference - London with Tower Bridge" />
      </div>

      <div className="image-full">
        <img src="/images/tedc/2016-boston.png" alt="The Email Design Conference - Boston with Zakim Bridge" />
      </div>

      <h3>2017: Conference rebranded to Litmus Live</h3>
      ...
      <div className="image-full">
        <img src="/images/tedc/2016-litmus-live-logos.png" alt="Litmus Live logo variations across cities" />
      </div>
      ...
      <div className="image-full">
        <img src="/images/tedc/2017-litmus-live-full.png" alt="Litmus Live 2017 full website design" />
      </div>

      <h3>Links</h3>

      <ul className="bulletedList">
        <li><a target="_blank" rel="noopener noreferrer" href="https://litmus.com/conference/2016">The Email Design Conference 2016 Website &rarr;</a></li>
        <li><a target="_blank" rel="noopener noreferrer" href="https://litmus.com/conference/2017">Litmus Live 2017 Website &rarr;</a></li>
        <li><a target="_blank" rel="noopener noreferrer" href="https://www.campaignmonitor.com/blog/email-marketing/2017/10/3-things-learned-at-litmus-live-that-change-email-marketing/">Litmus Live on the Campaign Monitor blog &rarr;</a></li>
      </ul>
    </CaseStudyLayout>
  );
}
