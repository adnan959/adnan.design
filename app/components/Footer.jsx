        ...
        <div className="row">
          <div className="col-md-6 col-xs-12">
            <div className="social-icons">
              <a href="https://www.linkedin.com/in/adnan959/" target="_blank" rel="noopener noreferrer">
              ...
              <a href="https://twitter.com/adnan959" target="_blank" rel="noopener noreferrer">
